...
//                   vertical: 2.5.h, // â† increased a bit for breathing room
//                   horizontal: 3.w,
//                 ),
//                 child: Column(
//                   mainAxisSize:
//                       MainAxisSize.min, // â† important: don't force max size
//                   mainAxisAlignment: MainAxisAlignment.center,
//                   children: [
...
//                             fontSize: 18.sp, // â† slightly smaller is safer
...
//                             alignText: TextAlign.center,
//                             fontSize: 14.sp,
//                             maxLines: 2, // â† increased to 3 lines
//                           ),
//                         ],
//                       ),
//                     ),
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                  vertical: 1.5.h, // â† reduced from 2.5.h
                  horizontal: 2.5.w, // â† reduced from 3.w
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.all(1.2.h), // â† reduced from 2.h
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        gradient: LinearGradient(
                          colors: [
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomText(
                            title: title,
                            alignText: TextAlign.center,
                            fontSize: 18.sp, // â† reduced from 18.sp
                            weight: FontWeight.w700,
                          ...
                          CustomText(
                            title: description,
                            alignText: TextAlign.center,
                            fontSize: 16.sp, // â† reduced from 14.sp
                            maxLines: 2,
